...
<Card title="VSCode Marketplace" icon="download" href="https://marketplace.visualstudio.com/items?itemName=namastexlabs.forge-kanban">
...
3. Search for `@id:namastexlabs.forge-kanban`
4. Click **Install**
</Tab>
...
**Solutions**:
- Verify the extension is installed by searching `@id:namastexlabs.forge-kanban` in Extensions
