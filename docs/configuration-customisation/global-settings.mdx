...
<Frame>
<img src="/images/af-settings.png" alt="Automagik Forge global settings page showing theme options, agent configuration, and GitHub integration settings" />
</Frame>
...
<Frame>
<img src="/images/af-editor-ssh.png" alt="Automagik Forge settings editor section showing ssh configuration options." />
</Frame>

When running Automagik Forge on a remote server (e.g., accessed via Cloudflare tunnel, ngrok, or as a systemctl service), you can configure VSCode-based editors to open projects via SSH instead of assuming localhost.
...
- Automagik Forge runs on a remote server (VPS, cloud instance, etc.)
...
- Status synchronisation directly from Automagik Forge
...
Enable or disable telemetry data collection to help improve Automagik Forge.
