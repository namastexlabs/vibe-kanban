...
<Info>
Agent profiles are used throughout Automagik Forge wherever agents run: onboarding, default settings, attempt creation, and follow-ups.
</Info>
...
<Note>
The configuration page displays the exact file path where your settings are stored. Automagik Forge saves only your overrides whilst preserving built-in defaults.
</Note>
...
<Card title="MCP Server Configuration" icon="server" href="/integrations/mcp-server-configuration">
  Configure MCP servers within Automagik Forge for your coding agents
</Card>

<Card title="Automagik Forge MCP Server" icon="plug" href="/integrations/automagik-forge-mcp-server">
  Connect external MCP clients to Automagik Forge's MCP server
</Card>
</CardGroup>
