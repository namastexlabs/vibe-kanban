...
description: "Complete guide to all coding agents supported by Automagik Forge, including installation and authentication instructions"
---

Automagik Forge integrates with a variety of coding agents. These agents are available via `npx` and can be selected when creating task attempts.
...
## Authentication
You need to authenticate with Claude Code outside of Automagik Forge before using it. Please follow the authentication instructions on the [Claude Code GitHub page](https://github.com/anthropics/claude-code).
</Accordion>
...
## Authentication
You need to authenticate with OpenAI Codex outside of Automagik Forge before using it. Please follow the authentication instructions from the [OpenAI help center](https://help.openai.com/en/articles/11369540-using-codex-with-your-chatgpt-plan) to use Codex with your ChatGPT plan.
...
## Authentication
You need to authenticate with Amp outside of Automagik Forge before using it. Please follow the authentication instructions on the [Amp Owner's Manual](https://ampcode.com/manual#install).
</Accordion>
...
## Authentication
Authenticate and configure CCR outside of Automagik Forge. Follow the instructions on the CCR GitHub repo:
...
## Configure Automagik Forge

Automagik Forge does not ship a default configuration for CCR. Add configurations to the existing Claude Code agent:
...
### Example: Claude Code agent configuration in Automagik Forge

<Frame>
<img src="/images/af-ccr-agent-config.png" alt="Claude Code agent configuration in Automagik Forge" />
</Frame>

## Using CCR in Automagik Forge
...
## Authentication
You need to authenticate with Gemini CLI outside of Automagik Forge before using it. Please follow the authentication instructions on the [Gemini CLI GitHub page](https://github.com/google-gemini/gemini-cli).
</Accordion>
...
## Authentication
You need to authenticate with OpenCode outside of Automagik Forge before using it. Please follow the authentication instructions on the [OpenCode GitHub page](https://github.com/sst/opencode).
</Accordion>
...
## Authentication
You need to authenticate with Qwen outside of Automagik Forge before using it. Please follow the authentication instructions in the official Qwen documentation: https://github.com/QwenLM/qwen-code
</Accordion>
