...
Automagik Forge transforms how developers work with AI coding agents by providing:
...
Ready to get started? Follow our getting started guide to install and configure Automagik Forge:

<Card title="Get Started" icon="rocket" href="/getting-started">
  Install Automagik Forge and complete the setup process in minutes
</Card>
