...
<Step title="Install Web Companion">
  For precise component selection, install the `automagik-forge-web-companion` package in your application.
  ...
  **Manual Installation:**
  ...
  ```bash
  npm install automagik-forge-web-companion
  ```
  ...
  <Tab title="Create React App">
    ...
    ```jsx
    import { AutomagikForgeWebCompanion as AutomagikForgeWebCompanion } from 'automagik-forge-web-companion';
