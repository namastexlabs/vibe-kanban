...
#### Preview Tab
The Preview tab provides an embedded browser experience for testing web applications directly within Automagik Forge. When you start a development server, the tab automatically detects the URL and displays your running application in an embedded iframe. This eliminates the need to switch between your browser and Automagik Forge during development.
